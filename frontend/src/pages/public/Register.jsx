      ...
      <div className="relative z-10 w-full max-w-lg p-8 m-4 rounded-3xl shadow-2xl bg-white/80 backdrop-blur-md border border-white/50">
        ...
        <div className="flex flex-col items-center mb-6">
          ...
          <div className="mt-6 text-center py-6">
            <p className="text-lg font-bold text-jardinerie-text mb-2">Vérifiez votre boîte mail ! 📬</p>
            <p className="text-sm text-gray-600">
              Un email de confirmation a été envoyé à <strong>{formData.email}</strong>.
              Cliquez sur le lien qu'il contient pour activer votre compte.
            </p>
            <Link to="/connexion" className="mt-6 inline-block text-jardinerie-primary underline font-medium">
